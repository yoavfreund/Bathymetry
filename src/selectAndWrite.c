...
// if xyzi in first file is inside WESN provided write to second file else do nothing
//
...
#define LINESZ 1024
	...
	tileFile = fopen(tileFileName,"wt"); 
	if (tileFile == NULL) {printf ("can't open %s in wt mode\n", tileFileName); return 1; }
