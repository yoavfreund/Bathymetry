...
if ($#argv < 4) then
	echo " "
	echo "  example: `basename $0` pred.median.xyz arcticXyz surfaceOpts pred.unmasked.grd"
	echo " "
	exit
endif

set bxyz	= $1;   shift
set arcticxyz	= $1;   shift
set out		= $1;   shift
set opts	= "$*"

#/bin/rm -rf *out.grd
#
set B1 = -180./180./66./90.;
set B2 = -180./180./28./70.;
set B3 = -180./180./-2./32.;
set B4 = -180./180./-32./02.;
set B5 = -180./180./-62./-28.;
set B6 = -180./180./-90./-58.;
#
set C1 = -180./180./68./90.;
set C2 = -180./180./30./68.;
